rm(list = ls())
setwd("C:/Users/sadaf.mehdi/Desktop/Data Science/Project 2")
...
# new features will be year,month,day_of_week,hour from pickup_datetime variable
...
plot(lm_model$fitted.values,rstandard(lm_model),main = "Residual plot",
     xlab = "Predicted values of fare_amount",ylab = "standardized residuals")

#lm_predictions = predict(lm_model,test_data[,c(2,6)])
